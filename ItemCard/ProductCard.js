...
const ProductCard = ({ existingOnPress }) => {
   ...
   const product = {
      ...
      price: 23.14,
      image: require('../assets/images/gown_1-removebg-preview.png'),
   };
   ...
   return (
      <View style={styles.container}>
         <TouchableOpacity onPress={() => navigation.navigate('ProductDetailsOne')}>
