...
const ProductCardthree = ({ existingOnPress }) => {
   ...
   const product = {
      ...
      name: 'Cotton Hoodie',
      price: 45.23,
      image: require('../assets/images/hoodie_1-removebg-preview.png'),
   };
   ...
   return (
      <View style={styles.container}>
         <TouchableOpacity onPress={() => navigation.navigate('ProductDetailsThree')}>
