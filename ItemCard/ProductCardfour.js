...
const ProductCardfour = ({ existingOnPress }) => {
   ...
   const product = {
      ...
      name: 'Skull Hoodie',
      price: 67.42,
      image: require('../assets/images/hoodie_2-removebg-preview.png'),
   };
   ...
   return (
      <View style={styles.container}>
         <TouchableOpacity onPress={() => navigation.navigate('ProductDetailsFour')}>
